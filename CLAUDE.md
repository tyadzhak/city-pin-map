...
└── assets/
    └── icons/          # 26 SVG files: 6 from PI-001 + 20 from PIL-001 starter set (Heroicons + Tabler + 2 hand-authored)
```
